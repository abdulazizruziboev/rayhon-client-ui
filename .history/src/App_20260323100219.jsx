...
function FoodRow({ food, isLast }) {
  return (
    <div
      ...
      className={`relative flex gap-3 px-[6.5px] py-2.5 overflow-hidden outline-[#1bac4b] ${food.mavjudligi ? 'cursor-pointer' : 'cursor-default'}`}
    >
      <ImageWithLoader
        src={getMainImage(food)}
        alt={food.nomi}
        className="h-[84px] w-[84px] shrink-0 rounded-[140px] object-cover"
      />
