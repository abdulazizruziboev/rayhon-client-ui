      ...
      <section className="mx-auto max-w-7xl">
        ...
        <div className="sticky top-0 z-20 mb-4 bg-white pb-2">
          <div className="relative">
            ...
            >
              <div
                className={`pointer-events-none absolute inset-y-0 left-0 z-10 w-8 bg-gradient-to-r from-white to-transparent transition-opacity duration-200 bg-red-500 ${
              ...
              <div
                ...
                className="flex flex-1 items-center gap-2 overflow-x-auto pb-1 pr-4 no-scrollbar"
