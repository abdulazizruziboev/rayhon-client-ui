              ...
              <div className="h-[46px] rounded-full border border-[#1bac4b33] bg-white px-4 ring-1 ring-[#1bac4b]/95 shadow-[0_18px_36px_-28px_rgba(27,172,75,0.38)]">
                ...
                >
                  ...
                  <button
                    ...
                    className={`inline-flex size-8 shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition duration-300 hover:bg-slate-200 hover:text-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1bac4b] cursor-pointer ${search}`}
