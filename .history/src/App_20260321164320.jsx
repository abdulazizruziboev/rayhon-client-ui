          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-x-0 top-0 flex justify-between p-3">
                <button
                  type="button"
                  className="rounded-full bg-black/60 p-2 text-white backdrop-blur-3xl border-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white ml-auto"
