...
export default function App() {
  ...
  return (
    <motion.main
      ...
      className="relative min-h-screen flex flex-col overflow-xx-hidden bg-white p-3 text-slate-900 *:selection:bg-[#1bac4b33] *:selection:text-[#1bac4b]"
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 z-40 mb-4 bg-white py-2 pb-2">
