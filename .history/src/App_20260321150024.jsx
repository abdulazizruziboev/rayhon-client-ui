      ...
      <section className="mx-auto max-w-7xl">
        ...
        >
          <div className="flex w-full flex-col items-center">
            <a href="/" className='cursor-pointer !h-[80px]  overflow-hidden'><img
              src="/logo.png"
              alt="Rayhon logotipi"
              className="w-full max-w-[220px]  object-cover scale-350 bg-red-500 overflow-hidden"
            /></a>
          ...
          <section className="space-y-3">
            {searchResults.length > 0 ? (
              <>
                ...
                <FoodList foods={searchResults} animate={false} />
              </>
            ) : (
