        ...
        <div className="sticky top-0 z-20 mb-4 bg-white pb-2">
          <div className="relative">
            ...
            >
              ...
              />
              <div
                className={`pointer-events-none absolute inset-y-0 ${searchActive ? 'right-0' : 'right-10'} z-10 w-8 bg-gradient-to-l from-white to-transparent transition-opacity duration-200 mr-3 ${
