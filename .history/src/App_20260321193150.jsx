                ...
                {categoryButtons.map((category, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex shrink-0 cursor-pointer items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-medium backdrop-blur transition-all duration-300 ease-[cubic-bezier(.25,.8,.25,1)] outline-[#1bac4b] will-change-transform active:scla ${
                        isActive
