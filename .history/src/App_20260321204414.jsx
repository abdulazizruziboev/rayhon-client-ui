    ...
    >
      <section className="mx-auto max-w-7xl">
        <motion.div
          ...
          className="mb-4 px-1"
        >
<div className="w-full flex flex-col items-center justify-start pt-6 gap-2">
  <p className="text-[#1bac4b] text-sm sm:text-base md:text-lg leading-none text-start bg-red-500">
    Taomlar menyusi
  </p>
