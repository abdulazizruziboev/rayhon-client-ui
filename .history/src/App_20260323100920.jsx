...
{categoryButtons.map((category, index) => {
  ...
  return (
    ...
    >
      {/* IMAGE */}
      <div className="relative flex h-[60px] w-[60px] items-center justify-center rounded-full p-[3px]">
        ...
        {/* ring */}
        <div
          className={`absolute inset-0 rounded-full ring-2 ring-offset-1 ring-offset-white transition-all duration-300
            ${
              isActive
                ? "ring-[#1bac4b]"
                : "ring-gray-300"
