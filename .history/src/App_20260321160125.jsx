      ...
      <section className="mx-auto max-w-7xl">
        ...
        >
          <div className="flex w-full flex-col items-center">
            <a href="/" className='cursor-pointer w-full mx-auto !h-[80px]'>
            <img
              src="/logo.png"
              alt="Rayhon logotipi"
          ...
          <div className="relative">
            ...
            >
              ...
              <div
                ...
                className="flex flex-1 items-center gap-2 overflow-x-auto pb-1 pr-4 no-scrollbar mt-1.5"
              ...
              {!searchActive && (
                <button
                  ...
                  className="shrink-0 rounded-full border border-[#1bac4b33] bg-white p-2 shadow-sm transition-all duration-200 hover:border-[#1bac4b66] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1bac4b] active:bg-[#1bac4b66]"
                >
