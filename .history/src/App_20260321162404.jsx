      ...
      {foods.map((food) => (
        ...
        <div
          className={`grid grid-cols-[1fr_auto_auto_auto_auto] items-center gap-3 ${
            food.mavjudligi ? "" : "blur-[1px] opacity-70"
          }`}
        >
          {/* Nomi */}
                ...
                {categoryButtons.map((category, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex shrink-0 cursor-pointer items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-medium backdrop-blur transition duration-100 outline-[#1bac4b] ${
                        isActive
