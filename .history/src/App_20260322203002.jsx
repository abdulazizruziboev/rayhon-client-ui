            ...
            <div className="flex items-center gap-2">
              <div className="relative min-w-0 flex-1">
                ...
                <div
                  ...
                  data-catalog-swipe
                  className="flex items-center gap-2 overflow-x-auto pb-1 px-1.5 py-3 no-scrollbar mt-1.5"
    ...
    >
      ...
      >
        {category}
            ...
            >
              <div className="h-[46px] rounded-full border border-red-500 bg-white px-4 ring-1 ring-[#1bac4b]/95 shadow-[0_18px_36px_-28px_rgba(27,172,75,0.38)]">
                <div
